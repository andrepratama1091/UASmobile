            ...
            <View style={styles.vHeader}>                
                ...
                <View style={styles.box1}>
                    <TouchableHighlight activeOpacity={0.5} 
                        ...
                        <Text style={styles.txtBox2}>View Buku</Text>
                    </TouchableHighlight>
                
                </View>
                <View style={styles.box1}>
                    <TouchableHighlight activeOpacity={0.5} 
                        style={styles.BoxStyle} onPress={()=> this.props.navigation.navigate('Peminjaman') }>
                ...
                <View style={styles.box1}>
                    <TouchableHighlight activeOpacity={0.5} 
                        style={styles.BoxStyle} onPress={()=> this.props.navigation.navigate('ViewGambar') }>
                ...
                <View style={styles.box1}>
                    <TouchableHighlight activeOpacity={0.5} 
                        style={styles.BoxStyle} onPress={()=> this.props.navigation.navigate('ViewGambar') }>
                        <Text style={styles.txtBox2}>View Gambar</Text>
                    </TouchableHighlight>
                </View>
            </View> 
                </View>
